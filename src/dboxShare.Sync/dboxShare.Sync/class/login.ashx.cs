...
namespace dboxShare.Sync
{
    ...
    public class Login : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            if (AppCommon.LoginAuth("Sync") == true)
            {
        ...
        private void ProcessLogin(HttpContext Context)
        {
            ...
            Context.Cache.Insert("Login-Token-Sync-" + UserId.ToString() + "", Context.Session["LoginToken"].TypeString(), null, DateTime.MaxValue, TimeSpan.FromHours(12));
