...
namespace dboxShare.Web.Drive
{
    ...
    public class PurviewDataJson : IHttpHandler, IReadOnlySessionState
    {
        ...
        private void DataToJson(HttpContext Context)
        {
            ...
            Json = Base.Data.SqlDataToJson("Select DBS_Id, DBS_Folder, DBS_Share, DBS_Sync From DBS_File Where DBS_Id = " + Id, ref Conn);
