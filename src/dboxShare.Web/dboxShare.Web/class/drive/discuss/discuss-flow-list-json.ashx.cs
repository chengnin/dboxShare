...
namespace dboxShare.Web.Drive
{
    ...
    public class DiscussFlowListJson : IHttpHandler, IReadOnlySessionState
    {
        ...
        private void ListDataToJson(HttpContext Context)
        {
            ...
            {
                Query += "Select A.DBS_Id From DBS_Discuss As A Inner Join DBS_File On " + 
                         "DBS_File.DBS_Id = A.DBS_FileId Where " + 
                         "A.DBS_Id = DBS_Discuss.DBS_Id And " + 
                         "A.DBS_Revoke = 0 And " + 
            ...
            Query += "Not Exists (Select E.DBS_Id From DBS_Discuss As E Where " + 
                     "E.DBS_Id = DBS_Discuss.DBS_Id And " + 
                     "E.DBS_UserId = " + Context.Session["UserId"].TypeString() + " And " + 
                     "E.DBS_Revoke = 0)";

            Json = Base.Data.SqlPageToJson("DBS_Discuss", "DBS_Id, DBS_FileId, DBS_FileName, DBS_FileExtension, DBS_IsFolder, DBS_UserId, DBS_Username, DBS_Content, DBS_Time", "DBS_Id Desc", Query, 50, Page, ref Conn);
